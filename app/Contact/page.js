  ...
  return (
     <div className="h-screen px-1.5 gap-4 bg-gradient py-0">
       ...
       <main class="flex flex-col  my-5 mx-auto bg-gradient-to-t from-gray-500 to-white">
            ...
            <div class="bg-gray-200 mx-auto my-15 border-2 border-green-500  px-4 py-2 grid grid-cols-4">
                ...
                <a href="https://www.instagram.com/matttsui_/" class="hover:opacity-40 hover:scale-3d"><img src="instgram.svg" alt="The Instagram Logo" class="w-25 h-25"></img></a>
            </div>
        </main>
    </div>
  );
